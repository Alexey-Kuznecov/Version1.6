...
namespace UnityCommander.Plugin48.Core.Loader
{
    ...
    using UnityCommander.Plugin48.Core.Internal;
    ...
    internal class ManagedLoadContext : AssemblyLoadContext
    {
        ...
        public Action<object> Unloading { get; }
        ...
        private Assembly LoadFromStream(FileStream file)
        {
            throw new NotImplementedException();
        }

        private Assembly LoadFromStream(FileStream file, FileStream pdbFile)
        {
            throw new NotImplementedException();
        }
