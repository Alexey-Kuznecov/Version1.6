...
namespace UnityCommander.Plugin48.Core
{
    ...
    public class PluginConfig
    {
        ...
        public object DefaultContext { get; internal set; }

        /// <summary>
        /// If set, replaces the default <see cref="AssemblyLoadContext"/> used by the <see cref="AssemblyLoadContext"/>.
        /// Use this feature if the <see cref="Assembly"/> of the <see cref="AssemblyLoadContext.Default"/> is not the Runtime's default load context.
        /// i.e. (AssemblyLoadContext.GetLoadContext(Assembly.GetExecutingAssembly) != <see cref="AssemblyLoadContext"/>
        /// </summary>
