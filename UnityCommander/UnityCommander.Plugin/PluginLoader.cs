...
namespace UnityCommander.Plugin
{
    using System;
    ...
    using UnityCommander.Plugin.Loader;
    ...
    public class PluginLoader : IDisposable
    {
        ...
        internal AssemblyLoadContext LoadContext => this._context;
        ...
        public Assembly LoadAssembly(AssemblyName assemblyName)
        {
            this.EnsureNotDisposed();
#if !NET48
            return this._context.LoadFromAssemblyName(assemblyName);
#else
            return null;
#endif
        }
        ...
        public Assembly LoadAssemblyFromPath(string assemblyPath)
            => this._context.LoadAssemblyFromFilePath(assemblyPath);
        ...
        {
            this.EnsureNotDisposed();
            return this.LoadAssembly(new AssemblyName(assemblyName));
        }
        ...
        public AssemblyLoadContext.ContextualReflectionScope EnterContextualReflection()
            => this._context.EnterContextualReflection();
#endif
