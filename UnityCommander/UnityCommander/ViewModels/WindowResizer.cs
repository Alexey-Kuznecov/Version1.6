...
namespace UnityCommander.ViewModels
{
    ...
    public class WindowResizer
    {
        ...
        private void GetTransform()
        {
            ...
            var source = PresentationSource.FromVisual(this.mWindow);
        ...
        private void Window_SizeChanged(object sender, SizeChangedEventArgs e)
        {
            ...
            var windowTopLeft = this.mTransformToDevice.Transform(new Point(left, top));
            var windowBottomRight = this.mTransformToDevice.Transform(new Point(right, bottom));

            // Check for edges docked
            var edgedTop = windowTopLeft.Y <= (this.mScreenSize.Top + this.mEdgeTolerance);
            var edgedLeft = windowTopLeft.X <= (this.mScreenSize.Left + this.mEdgeTolerance);
            var edgedBottom = windowBottomRight.Y >= (this.mScreenSize.Bottom - this.mEdgeTolerance);
            var edgedRight = windowBottomRight.X >= (this.mScreenSize.Right - this.mEdgeTolerance);
        ...
        private void WmGetMinMaxInfo(System.IntPtr hwnd, System.IntPtr lParam)
        {
            ...
            // Set min size
            var minSize = this.mTransformToDevice.Transform(new Point(this.mWindow.MinWidth, this.mWindow.MinHeight));
