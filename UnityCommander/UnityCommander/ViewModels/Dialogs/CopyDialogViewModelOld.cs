...
namespace UnityCommander.ViewModels.Dialogs
{
    ...
    /// </summary>
    public class CopyDialogViewModelOld : BindableBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CopyDialogViewModelOld"/> class.
        ...
        public CopyDialogViewModelOld(IEventAggregator viewModelMessage)
        {
