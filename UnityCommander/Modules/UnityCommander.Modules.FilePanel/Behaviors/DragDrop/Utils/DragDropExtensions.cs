...
namespace UnityCommander.Modules.FilePanel.Behaviors.DragDrop.Utils
{
    ...
    public static class DragDropExtensions
    {
        ...
        {
            return element != null && GongSolutions.Wpf.DragDrop.DragDrop.GetDragSourceIgnore(element);
        }
        ...
        {
            return element != null && GongSolutions.Wpf.DragDrop.DragDrop.GetIsDragSource(element);
        }
        ...
        {
            return element != null && GongSolutions.Wpf.DragDrop.DragDrop.GetIsDropTarget(element);
        }
